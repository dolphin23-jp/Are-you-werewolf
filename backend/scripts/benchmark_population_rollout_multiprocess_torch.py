"""Benchmark centralized-inference multiprocess population rollout."""
...
from app.training.torch_population import TorchProfileEvaluationRequest
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="werewolf-rollout-mp-benchmark-") as tmp_dir:
    ...
    print("===== MULTIPROCESS POPULATION ROLLOUT BENCHMARK =====")
    ...
    print("===== END MULTIPROCESS POPULATION ROLLOUT BENCHMARK =====")
